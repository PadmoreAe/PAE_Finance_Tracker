"""
Django settings for pae_finance project.
...
WSGI_APPLICATION = 'pae_finance.wsgi.application'
...
# Optional: Customize token lifetime (ALX likes to see you know how to configure things!)
SIMPLE_JWT = {
